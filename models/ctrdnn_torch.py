...
from models.ctr_model_utils import build_input_features, SparseFeat, DenseFeat, VarLenSparseFeat, \
...
def get_dnnfm(struct_config):
    ...
    model = DNNFM(col_names, col_names, dnn_use_bn=True, dnn_activation="leakyrelu", init_std=0.0001)
    return model
