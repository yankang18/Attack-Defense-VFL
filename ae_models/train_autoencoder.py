...
from utils import get_timestamp, sharpen
...
def train_batch(model, optimizer, code_y, hyperparameter_dict):
    ...
    lambda_2 = hyperparameter_dict["lambda_2"]
    ...
    loss_p = cross_entropy_for_one_hot(code_y_hat, code_y)
    # loss_p = criterion(code_y_hat, label_y)
    loss_n = cross_entropy_for_one_hot(code_D_y, code_y)
...
if __name__ == '__main__':
    ...
    lambda_2 = 0.0
    hyperparameter_dict["lambda_2"] = lambda_2
    # epochs = 50
    # T = 0.05
    ...
    model_name = f"autoencoder_{num_classes}_{lambda_2}_{timestamp}"
